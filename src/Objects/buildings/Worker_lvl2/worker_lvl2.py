...
class Worker_lvl2(Building):
    id: int = 0

    def __init__(self):
        """This is documentation for Steel_furnace"""
        Worker_lvl2.id += 1
        self.__id = Worker_lvl2.id
        super().__init__()
        self._skin: str = "sprites/my_rect_sprites/assembling-machine-2.png"
        ...
        self.active_skin: str = "sprites/my_rect_sprites/assembling-machine-2.png"
        self.inactive_skin: str = "sprites/my_rect_sprites/assembling-machine-2.png"
